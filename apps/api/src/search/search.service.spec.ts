...
describe("SearchService", () => {
  ...
  it("returns empty results for blank query", async () => {
    const result = await service.search("", 5, "org-1");
  ...
  it("queries all three entities in parallel", async () => {
    ...
    const result = await service.search("alice", 5, "org-1");
  ...
  it("maps customer results correctly", async () => {
    ...
    const result = await service.search("bob", 5, "org-1");
  ...
  it("maps tracking link results correctly", async () => {
    ...
    const result = await service.search("summer", 5, "org-1");
  ...
  it("respects the limit parameter", async () => {
    ...
    await service.search("test", 3, "org-1");
